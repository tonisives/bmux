...
- `pnpm check`: TypeScript, React ESLint rules, and six model/persistence/import tests.
- `pnpm test:electron`: three integration scenarios using disposable profile directories and local HTTP fixtures.
