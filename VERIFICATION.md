...
- `pnpm check`: TypeScript, React ESLint rules, and ten model/persistence/import/command/config tests.
- `pnpm test:electron`: five integration scenarios using disposable profile directories and local HTTP fixtures.
