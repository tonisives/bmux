...
export let DEFAULT_KEYBOARD: KeyboardConfig = {
  ...
  shortcuts: {
    ...
    'Cmd+T': 'new-window', 'Cmd+W': 'close-window', 'CmdOrCtrl+Shift+T': 'reopen-closed', 'Cmd+Shift+W': 'detach', 'Cmd+N': 'new-client', 'Cmd+Shift+N': 'new-client', 'Cmd+D': 'bookmark',
