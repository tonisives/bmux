...
export let DEFAULT_KEYBOARD: KeyboardConfig = {
  ...
  shortcuts: {
    ...
    'Cmd+T': 'new-tab', 'Cmd+W': 'close-tab', 'Cmd+N': 'new-client', 'Cmd+Shift+N': 'new-client',
  ...
  prefixBindings: { ':': 'command', '?': 'help', c: 'new-window', n: 'next-window', p: 'previous-window', '%': 'split-right', '"': 'split-down', o: 'next-pane', s: 'sessions', d: 'detach', ',': 'settings' },
}
export let KEY_ACTIONS = new Set(['address', 'command', 'find', 'help', 'sessions', 'tabs', 'bookmarks', 'activity', 'profiles', 'settings', 'reload', 'hard-reload', 'stop', 'new-tab', 'close-tab', 'new-client', 'new-window', 'next-window', 'previous-window', 'next-pane', 'split-right', 'split-down', 'detach', 'back', 'forward', 'next-tab', 'previous-tab', 'zoom-in', 'zoom-out', 'zoom-reset'])
