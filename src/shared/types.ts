...
export type PasswordSuggestions = { id: string; tabId: string; origin: string; anchor: FieldBounds; locked: boolean; expanded?: boolean; busy?: boolean; message?: string; items: { id: string; name: string; username: string }[] }
export type PublicState = { findResults?: Record<string, FindResult>; passwordSuggestions?: PasswordSuggestions; bitwardenMessage?: string; browserTools?: BrowserToolsState; plugins?: PluginInfo[]; pluginRuns?: PluginRun[]; pluginPrompt?: PluginPrompt; accessibility?: boolean; statusBar?: StatusBarPosition; keyboard?: KeyboardConfig; configPath?: string; configError?: string | null; model: Model; clientId: string; focusedClientId: string | null; snapshots: Record<string, Snapshot>; crashes: Record<string, string>; loading: Record<string, boolean>; pendingUrls: Record<string, string>; permissions: Permission[]; downloads: Download[] }
