...
export let HELP_NOTES = [
  ...
  'Bookmarks search titles and folder names in the selected pane’s profile. Folder context stays visible. Up/Down moves, Enter opens in that pane, and Command+Enter opens in a new tab; Escape clears search first, then closes.',
