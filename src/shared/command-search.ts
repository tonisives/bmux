...
export let HELP_NOTES = [
  ...
  'Bookmarks search titles first, then folder names and URLs in the selected pane’s profile. Folder context stays visible. Up/Down moves, Enter opens in that pane, and Command+Enter opens in a new tab; Escape clears search first, then closes.',
