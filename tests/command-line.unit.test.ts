...
let state = (): PublicState => {
  ...
  return { model, clientId: 'client', focusedClientId: 'client', snapshots: {}, crashes: {}, loading: {}, favicons: {}, pendingUrls: {}, navigation: {}, permissions: [], downloads: [], profileCaches: {}, profileProxyTests: {} }
}
